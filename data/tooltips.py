...
Levels higher than 4 offer marginal returns.""",
    ...
    "keep_if_larger": "Prevents \"Delete Original\" and \"Replace\" options (output tab) from deleting the original image if the result is larger. Ignored when mode is set to \"JPEG Reconstruction\".",
